      ...
      >
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8 max-w-sm sm:max-w-md w-full border border-white/20 shadow-2xl">
          <div className="text-center">
            ...
            <button
              onClick={resetOrder}
              className="w-full py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold rounded-xl transition-all duration-300 text-sm sm:text-base"
            >
              Continue Shopping
            </button>
          </div>
